...
},{"./v1":"node_modules/uuid/v1.js","./v4":"node_modules/uuid/v4.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
document.addEventListener('change', function (e) {
  ...
  var parent = e.target.closest('.list-item');
  var itemId = parent.dataset.itemId;
  var todo = todoArray.find(function (t) {
    return t.id === itemId;
  });
...
document.addEventListener('click', function (e) {
  ...
  var parent = e.target.closest('.list-item');
  var itemId = parent.dataset.itemId;
  todoArray = todoArray.filter(function (t) {
    return t.id !== itemId;
  });
  parent.remove();
  saveTodo();
...
function renderTodo(todo) {
  ...
  var inputText = templateClone.querySelector('[data-list-item-text]');
  var container = templateClone.querySelector('.list-item');
  container.dataset.itemId = todo.id;
  var checking = templateClone.querySelector('[data-list-item-checkbox]');
  checking.checked = todo.complete;
  inputText.innerText = todo.text;
  list.appendChild(templateClone);
}
function loadTodos() {
  var item = localStorage.getItem(LOCAL);
  return JSON.parse(item) || [];
}
function saveTodo() {
  localStorage.setItem(LOCAL, JSON.stringify(todoArray));
}
},{"uuid":"node_modules/uuid/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
